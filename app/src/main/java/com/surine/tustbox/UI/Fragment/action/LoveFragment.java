        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if(view == adapter.getViewByPosition(recycleview,position,R.id.item_love_head)){
                    //启动个人详情页
                    startActivity(new Intent(getActivity(), V5_UserInfoActivity.class).putExtra(FormData.uid,loves.get(position).getUid()));
                }
            }
        });
        return v;
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (jsonObject.getInt(FormData.JCODE) == 400) {
                        ...
                        lovesFromServer = JsonUtil.parseJsonWithGsonToList(s1, Love.class);
