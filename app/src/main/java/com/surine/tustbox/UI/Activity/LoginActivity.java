...
public class LoginActivity extends TustBaseActivity {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.dknowtustNumber:
                startActivity(new Intent(context, V5_WebViewActivity.class).putExtra(Constants.TITLE, "说明").putExtra(Constants.URL, UrlData.login_introduce));
                break;
            case R.id.userl:
    ...
    private int loginJWCNew(final String tustNumber, final String passWord) {
        ...
        FormBody formBody = new FormBody.Builder()
                ...
                .add(FormData.login_captcha_new, "error")
                .build();
