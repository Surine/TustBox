...
public class EmptyClassRoomActivity extends TustBaseActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.info) {
            startActivity(new Intent(context,V5_WebViewActivity.class).putExtra(Constants.TITLE,"说明").putExtra(Constants.URL,UrlData.emptyClassRoomUserIntroduce));
        }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Intent intent = new Intent(EmptyClassRoomActivity.this,V5_WebViewActivity.class);
