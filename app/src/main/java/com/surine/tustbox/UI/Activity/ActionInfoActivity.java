            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (jsonObject.getInt(FormData.JCODE) == 400) {
                        action = JsonUtil.parseJsonWithGson(jsonObject.getString(FormData.JDATA), Action.class);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (action.getPic_ids() != null && !action.getPic_ids().equals("")) {
                                    ...
                                    ivNgridLayout.setAdapter((new MyImageDisplayAdapter(context, imageInfo)));
                                }
                            }
                        });
                    } else {
