...
public class SchoolPageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        xmlMsgTopbar.setTitle("动态").setLeftIcon(R.drawable.ic_person_black_24dp)
                .setRightIcon(R.drawable.ic_add_black_24dp)
        ...
        //设置动态列表及适配器
        adapter = new ActionListAdapter(R.layout.item_action, actions);
        ...
        adapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                if (view == adapter.getViewByPosition(resList, position, R.id.love)) {
                    ...
                    Intent intent = new Intent(getActivity(), V5_UserInfoActivity.class).putExtra(FormData.uid, actions.get(position).getUid());
...
//        subjectList.setAdapter(subjectHeaderAdapter);
                    ...
                    if (jsonObject.getInt(FormData.JCODE) == 2000) {
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                List<Subject> subjects = JsonUtil.parseJsonWithGsonToList(s, Subject.class);
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                try {
                    ...
                    if (jsonObject.getInt("jcode") == 400) {
                        ...
                        actionsFromServer = JsonUtil.parseJsonWithGsonToList(s1, Action.class);
    ...
    private void userInfo() {
        String uid = SharedPreferencesUtil.Read(getActivity(), FormData.tust_number_server, "");
        Intent intent = new Intent(getActivity(), V5_UserInfoActivity.class).putExtra(FormData.uid, uid);
