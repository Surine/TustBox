...
public class TimeUtil {
     ...
     * @param a 上课节数
     */
    public static String getCourseSessionShow(String a){
        String r = "00·00";
        if(a.contains("1")){
            r = "08·20";
        }else if(a.contains("3")){
    ...
    //获取日子中文
    public static String getDayCC(String dateString){
        String day = getStringByTimeString(dateString,"dd");
        if(day == null){
            return null;
        }else{
            int dayNumber = Integer.parseInt(day);
            return dayCC[dayNumber - 1];
        }
    }
