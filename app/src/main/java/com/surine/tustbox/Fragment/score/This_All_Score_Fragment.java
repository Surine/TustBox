...
public class This_All_Score_Fragment extends Fragment {
    private RecyclerView mRecyclerView;
    private List<Score_Info> mScore_infos = new ArrayList<>();
    private List<Score_Info> mLastScore_infos = new ArrayList<>();
    private static final String ARG_ ="This_All_Score_Fragment" ;
    View v;
    public static This_All_Score_Fragment getInstance(String title) {
        This_All_Score_Fragment fra = new This_All_Score_Fragment();
